...
public class LocalizarMuro {
    ...
    public int[] GetDistribuccion(int nivel){
        if (nivel == 1){
    ...
    private int[] distribuccionNivel10 (){
        int [] distribuccion = new int[76];
        Random r = new Random();
        int indice = r.nextInt(4);
        if (indice == 0){
            for (int i = 0; i < distribuccion.length; i++){
                if (i >= 63 && i <= 68){
                    distribuccion[i] = 0;
                }else{
                    distribuccion[i] = 1;
    ...
    private int[] distribuccionNivel9 (){
        int [] distribuccion = new int[76];
        Random r = new Random();
        int indice = r.nextInt(4);
        if (indice == 0){
    ...
    private int[] distribuccionNivel8 (){
        int [] distribuccion = new int[76];
        Random r = new Random();
        int indice = r.nextInt(4);
        if (indice == 0){
    ...
    private int[] distribuccionNivel7 (){
        int [] distribuccion = new int[76];
        Random r = new Random();
        int indice = r.nextInt(4);
        if (indice == 0){
    ...
    private int[] distribuccionNivel6 (){
        int [] distribuccion = new int[76];
        Random r = new Random();
        int indice = r.nextInt(4);
        if (indice == 0){
    ...
    private int[] distribuccionNivel5 (){
        int [] distribuccion = new int[56];
        Random r = new Random();
        int indice = r.nextInt(4);
        if (indice == 0){
            for (int i = 0; i < distribuccion.length; i++){
    ...
    private int[] distribuccionNivel4 (){
        int [] distribuccion = new int[56];
        Random r = new Random();
        int indice = r.nextInt(4);
        if (indice == 0){
    ...
    private int[] distribuccionNivel3 (){
        int [] distribuccion = new int[56];
        Random r = new Random();
        int indice = r.nextInt(4);
        if (indice == 0){
    ...
    private int[] distribuccionNivel2(){
        int [] distribuccion = new int[56];
        Random r = new Random();
        int indice = r.nextInt(4);
        if (indice == 0){
    ...
    private int[] distribuccionNivel1(){
        int [] distribuccion = new int[56];
        Random r = new Random();
        int indice = r.nextInt(4);
        if (indice == 0){
